        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 space-y-6">
            <div className="space-y-0">
              <h1 className="font-light cormorant uppercase" style={{ letterSpacing: '0.3em' }}>{t("groomFirstname")}</h1>
            ...
            <div className="space-y-0">
              <h1 className="font-light cormorant uppercase" style={{ letterSpacing: '0.3em' }}>{t("brideFirstname")}</h1>
              <h2 className="text-2xl md:text-3xl font-light cormorant text-primary/80 -mt-2 uppercase">
                {t("brideSurname")}
              </h2>
            </div>
